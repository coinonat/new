...
void StatisticsPage::updateStatistics()
{
    ...
    float volume = ((pindexBest->nMoneySupply)/100000000);
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " CXT" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " CXT" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " CXT");
    }
