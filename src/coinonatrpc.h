...
#ifndef _coinonatRPC_H_
#define _coinonatRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // coinonat is not connected
...
/**
 * coinonat RPC command dispatcher.
 */
class CRPCTable
{
private:
