...
#ifndef H_coinonat_SCRIPT
#define H_coinonat_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CcoinonatAddress
 */
...
public:
    ...
    // Pre-version-0.6, coinonat always counted CHECKMULTISIGs
