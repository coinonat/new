...
contains(coinonat_NEED_QT_PLUGINS, 1) {
    DEFINES += coinonat_NEED_QT_PLUGINS
...
HEADERS += src/qt/coinonatgui.h \
    ...
    src/qt/coinonataddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/coinonat.cpp src/qt/coinonatgui.cpp \
    ...
    src/qt/coinonataddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/coinonatstrings.cpp \
    src/qt/coinonatamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/coinonat.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/coinonat_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/coinonat-qt.rc
...
windows:RC_FILE = src/qt/res/coinonat-qt.rc
